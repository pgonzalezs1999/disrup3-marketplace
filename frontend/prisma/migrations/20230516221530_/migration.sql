/*
  ...
  - You are about to drop the column `links` on the `Collection` table. All the data in the column will be lost.
...
CREATE TABLE "new_Collection" (
    ...
    "discord" TEXT NOT NULL DEFAULT 'https://www.google.com',
    "twitter" TEXT NOT NULL DEFAULT 'https://www.google.com'
);
INSERT INTO "new_Collection" ("address", "bgImage", "floorPrice", "name", "owner", "profileImage") SELECT "address", "bgImage", "floorPrice", "name", "owner", "profileImage" FROM "Collection";
