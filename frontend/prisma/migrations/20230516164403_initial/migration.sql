...
CREATE TABLE "new_Collection" (
    ...
    "floorPrice" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_Collection" ("address", "bgImage", "floorPrice", "links", "owner", "profileImage") SELECT "address", "bgImage", "floorPrice", "links", "owner", "profileImage" FROM "Collection";
